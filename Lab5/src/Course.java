...
public class Course implements Comparable<Course> {
    ...
    public boolean equals(Object other) {
        return (other instanceof Course && this.id == ((Course) other).getId());
    }
    ...
    public String toString() {
        return "Course{id=" + id + ", name='" + name + "', level=" + level+ ", professor=" + professor + ", students=" + students + "}";
    }
